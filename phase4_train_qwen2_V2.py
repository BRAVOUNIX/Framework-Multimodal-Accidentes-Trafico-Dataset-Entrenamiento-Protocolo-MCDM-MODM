"""
FASE 4: Fine-tuning Qwen2-7B-Instruct
======================================
...
def main():
    parser = argparse.ArgumentParser(description='Fine-tuning Qwen2-7B')
    ...
    parser.add_argument('--output_dir', type=str, default='/workspace/models/phase4_llm/qwen2-7b')
